    ...
    return (
      ...
      />
        <View style={styles.bucksContainer}>
          <TouchableOpacity onPress={()=>props.navigation.navigate('VBucks')}>
            <Image
          ...
          <TouchableOpacity onPress={()=>props.navigation.navigate('SaveWorld')}>
            <Image
        ...
        <View style={[styles.bucksContainer,{marginTop:height(6),justifyContent:'center'}]}>
          <TouchableOpacity onPress={()=>props.navigation.navigate('BattlePass')}>
            <Image
